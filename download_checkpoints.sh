...
echo "Downloading gauge_detect.pth..."
wget -O checkpoints/gauge_detect.pth https://huggingface.co/hcltech-robotics/gauge_detect/resolve/main/gauge_detect3_hcl.pt.state_dict.pth
