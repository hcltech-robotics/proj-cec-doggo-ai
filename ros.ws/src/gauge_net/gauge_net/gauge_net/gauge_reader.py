...
class GaugeReader(Node):
    def __init__(self):
        ...
        self.scaling_min = (
            self.get_parameter("scaling_min").get_parameter_value().double_value
        )
        self.scaling_max = (
            self.get_parameter("scaling_max").get_parameter_value().double_value
        )
    ...
    def image_callback(self, msg):
        ...
        print(reading)
        scaled_reading = self.scaling_min + reading * (
