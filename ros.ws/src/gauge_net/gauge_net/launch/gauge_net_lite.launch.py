...
def generate_launch_description():
    ...
    ld.add_action(
        launch.actions.DeclareLaunchArgument(
            "use_math",
            description="If set to true, use mathematical approach"
            + "for reading gauges instead of neural network.",
    ...
    model_server_url = LaunchConfiguration(
        "model_server_url", default=default_model_server_url
    )
    ...
    rectify_node = ComposableNode(
        ...
        name="rectify",
        namespace="apriltag",
        remappings=[("image", image_topic), ("camera_info", camera_info_topic)],
    )
